...
$total_reservations = mysqli_query($conn, 'SELECT COUNT(*) FROM booking') or die(mysqli_error());
$display_reservations = $total_reservations -> fetch_array();
$reservations = $display_reservations['COUNT(*)'];

$total_price = mysqli_query($conn, 'SELECT COALESCE(SUM(price), 0.00) FROM booking WHERE current_status = "Approved"') or die(mysqli_error());
$display_price = $total_price -> fetch_array();
$price = $display_price['COALESCE(SUM(price), 0.00)'];

$total_reservations_approved = mysqli_query($conn, 'SELECT COUNT(*) FROM booking WHERE current_status = "Approved"') or die(mysqli_error());
$display_reservations_approved = $total_reservations_approved -> fetch_array();
$reservations_approved = $display_reservations_approved['COUNT(*)'];

$total_reservations_cancelled = mysqli_query($conn, 'SELECT COUNT(*) FROM booking WHERE current_status = "Cancelled"') or die(mysqli_error());
$display_reservations_cancelled = $total_reservations_cancelled -> fetch_array();
$reservations_cancelled = $display_reservations_cancelled['COUNT(*)'];
?>
<!DOCTYPE html>
<html lang="en" ng-app="myApp">
    ...
    <body class="sb-nav-fixed" ng-controller="myCtrl">
            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><a class="dropdown-item" href="admin_page.php">Profile</a></li>
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="admin_page_archives.php">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4"><?php echo("{$_SESSION['admin_name']}");?>'s Profile</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Welcome <?php echo("{$_SESSION['admin_name']}");?> to your Profile!</li>
                        </ol>
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body">
                                        <p class="card-text">Reservations Today</p>
                                        <h4 class="card-text"><?=$reservations;?></h4>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-warning text-white mb-4">
                                    <div class="card-body">
                                        <p class="card-text">Total ₱ Earned (Approved)</p>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-success text-white mb-4">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-text"><?=$reservations_approved;?></h4>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-danger text-white mb-4">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-text"><?=$reservations_cancelled;?></h4>
                                    </div> 
                                </div>
                            </div>
                        </div>
                                        ...
                                        <tbody class="table-group-divider">
                                            <tr ng-repeat="person in filteredData = (people | filter:searchText) | orderBy:sortColumn:reverseSort | limitTo: pageSize : (currentPage - 1) * pageSize">
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#personModal2" ng-click="openModal2(person)">
                                                    Edit
                                                    </button>
                                                </td>
                                            </tr>
                ...
                <div class="modal fade" id="personModal2" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="personModal2Label" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5" id="personModal2Label">Entry Details</h1>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <center>
                                    ...
                                    <b><u>Price:</u></b> {{ selectedPerson.price }}<br>
                                    <br>
                                    <button class="btn btn-success" data-bs-target="#approveWarning" data-bs-toggle="modal">Approve</button>
                                    <button class="btn btn-danger" data-bs-target="#archiveWarning" data-bs-toggle="modal">Archive</button>
                                </center>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                ...
                <div class="modal fade" id="approveWarning" aria-hidden="true" aria-labelledby="approveWarningLabel" tabindex="-1">
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5" id="approveWarningleLabel">Warning</h1>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                You are about to APPROVE this entry are you sure?
                            </div>
                            <div class="modal-footer">
                                <button ng-click="updatePerson($event)" class="btn btn-success" data-value="{{ selectedPerson.codeid }}">Approve Entry</button>
                                <button class="btn btn-secondary" data-bs-target="#personModal2" data-bs-toggle="modal">Back to Entry</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="modal fade" id="archiveWarning" aria-hidden="true" aria-labelledby="archiveWarningLabel" tabindex="-1">
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5" id="archiveWarningleLabel">Warning</h1>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                You are about to ARCHIVE this entry are you sure?
                            </div>
                            <div class="modal-footer">
                                <button ng-click="archivePerson($event)" class="btn btn-danger" data-value="{{ selectedPerson.codeid }}">Archive Entry</button>
                                <button class="btn btn-secondary" data-bs-target="#personModal2" data-bs-toggle="modal">Back to Entry</button>
                            </div>
                        </div>
                    </div>
        ...
        app.controller("myCtrl", function($scope, $http) {
            ...
            $scope.openModal2 = function(person) {
                $scope.selectedPerson = person;
            ...
            $scope.updatePerson = function(event) {
                var codeid = event.target.getAttribute("data-value");
                $http.get("approve.php?codeid=" + codeid)
                .then(function(response) {
            ...
            $scope.archivePerson = function(event) {
                var codeid = event.target.getAttribute("data-value");
                $http.get("archive.php?codeid=" + codeid)
                .then(function(response) {
                    console.log(response.data);
                    location.reload();
                });
