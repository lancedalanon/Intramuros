...
$total_reservations = mysqli_query($conn, 'SELECT COUNT(*) FROM archived_booking') or die(mysqli_error());
$display_reservations = $total_reservations -> fetch_array();
$reservations = $display_reservations['COUNT(*)'];

$total_price = mysqli_query($conn, 'SELECT COALESCE(SUM(price), 0.00) FROM archived_booking WHERE current_status = "Approved"') or die(mysqli_error());
$display_price = $total_price -> fetch_array();
$price = $display_price['COALESCE(SUM(price), 0.00)'];

$total_reservations_approved = mysqli_query($conn, 'SELECT COUNT(*) FROM archived_booking WHERE current_status = "Approved"') or die(mysqli_error());
...
$total_reservations_cancelled = mysqli_query($conn, 'SELECT COUNT(*) FROM archived_booking WHERE current_status = "Cancelled"') or die(mysqli_error());
...
<html lang="en" ng-app="myApp">
    <head>
        ...
        <title>Admin Archive Profile</title>
    ...
    <body class="sb-nav-fixed" ng-controller="myCtrl">
        ...
        app.controller("myCtrl", function($scope, $http) {
            $http.get("getPeopleAdminArchive.php")
