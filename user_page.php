    ...
    <body class="sb-nav-fixed" ng-controller="myCtrl">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <center>
                                    ...
                                    <br>
                                    <button class="btn btn-danger" data-bs-target="#cancelWarning" data-bs-toggle="modal">Cancel</button>
                                    <br>
                                </center>
                            </div>
                ...
                <div class="modal fade" id="cancelWarning" aria-hidden="true" aria-labelledby="cancelWarningLabel" tabindex="-1">
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5" id="cancelWarningleLabel">Warning</h1>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                You are about to CANCEL this entry are you sure?
                            </div>
                            <div class="modal-footer">
                                <button ng-click="updatePerson($event)" class="btn btn-danger" data-value="{{ selectedPerson.codeid }}">Cancel Entry</button>
                                <button class="btn btn-secondary" data-bs-target="#personModal" data-bs-toggle="modal">Back to Entry</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        app.controller("myCtrl", function($scope, $http) {
            ...
            $http.get("getPeopleUser.php?user_id=<?php echo json_encode($user_id); ?>")
            ...
            $scope.updatePerson = function(event) {
                ...
                $http.get("cancel.php?codeid=" + codeid)
                .then(function(response) {
